...
import { employeeStore } from "../../stores/employee/employee"
...
<template>
  <div class="p-3">
    <h2 class="uppercase dark:text-white text-gray-900">Employees</h2>
          ...
          <form @submit.prevent="addEmployee">
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
              <div>
                ...
                >
                <input
                  v-model="employeeInfo.full_name"
                  type="text"
                  name="name"
                  id="name"
              ...
              <div>
                ...
                >
                  ...
                  <option value="DELIVERYMAN">Eltuvchi</option>
