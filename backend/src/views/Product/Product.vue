...
import { productStore } from "../../stores/product/product"
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
              ...
              <div>
                ...
                >
                  ...
                  <option v-for="(el, index) in storePT.LIST" :key="index">{{ el.title }}</option>
                </select>
              </div>
            </div>
            <button
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-4 py-3">{{ new Date(el.addedAt).toJSON().split("T")[0] }}</td>
                  <td class="px-4 py-3">
                    <img
                      src="https://picsum.photos/id/321/40/40"
                      alt="mebel"
                      class="w-[42px] h-[42px] rounded-full object-cover border border-dashed"
                    />
                  </td>
